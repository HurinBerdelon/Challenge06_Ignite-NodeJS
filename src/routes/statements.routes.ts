...
import { MakeTransactionController } from '../modules/statements/useCases/makeTransaction/makeTransactionController';
...
const makeTransactionsController = new MakeTransactionController()
...
statementRouter.post('/transfer/:receiver_id', makeTransactionsController.handle);
